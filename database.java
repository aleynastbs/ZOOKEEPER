        ...
        try {
            ...
            stmt.executeUpdate(
                    "INSERT INTO Event(event_name, description, max_capacity, num_of_participants, date, start_at, end_at) VALUES"
                            + "('Group Tour 1', 'Cage Tour', 100, 20, DATE '2021-01-08', '10:00', '11:00'),"
                            + "('Group Tour 2', 'Animal Interactions', 50, 30, DATE '2020-07-08', '10:00', '11:00'),"
                            + "('Group Tour 3', 'Aquarium Tour', 150, 90, DATE '2021-08-08', '10:00', '11:00'),"
                            + "('Educational Program 1', 'Animal Care', 10, 8, DATE '2022-06-08', '10:00', '11:00'),"
                            + "('Educational Program 2', 'Cage Enclosure', 150, 40, DATE '2022-06-08', '10:00', '11:00'),"
                            + "('Cons. Organization 1', 'Safari Animals Protection', 50, 40, DATE '2022-06-08', '10:00', '11:00'),"
                            + "('Cons. Organization 2', 'Save Aquatic Life', 100, 80, DATE '2022-06-08', '10:00', '11:00'),"
                            + "('Cons. Organization 3', 'Stop Hunting', 50, 40, DATE '2021-07-03', '10:00', '11:00');");
            stmt.executeUpdate("INSERT INTO Group_Tour VALUES" + "(1)," + "(2)," + "(3);");
            stmt.executeUpdate("INSERT INTO Educational_Program VALUES" + "(4, 'Care Techniques'),"
                    + "(5, 'Cage Measuring');");
            stmt.executeUpdate("INSERT INTO Conservation_Organization VALUES"
                    + "(6, 10000, 800, 'Fund Raise')," + "(7, 6000, 5000, 'Fund Raise')," + "(8, 4000, 3600, 'Fund Raise');");
            stmt.executeUpdate("INSERT INTO Comments VALUES"
                    + "(1, 1, 1, DATE '2021-05-11'),"
                    + "(2, 9, 1, DATE '2021-04-03'),"
                    + "(3, 1, 2, DATE '2021-03-01'),"
                    + "(4, 9, 2, DATE '2020-08-16');");
            ...
            stmt.executeUpdate("INSERT INTO Animal(animal_species, animal_name) VALUES"
                    ...
                    + "('snake', 'aleyna')," + "('snake', 'lara')," + "('zebra', 'özge'),"
            ...
            stmt.executeUpdate(
                    "INSERT INTO Schedules (keeper_id, animal_id, training_description, training_date) VALUES"
                            ...
                            + "(2,1,'turn', DATE '2021-05-16'),"
                            + "(2,1,'sit', DATE '2021-05-18'),"
                            + "(2,2,'move around', DATE '2021-05-16'),"
                            + "(2,2,'turn', DATE '2021-05-14'),"
                            + "(2,2,'sit', DATE '2021-05-13'),"
                            + "(2,3,'move around', DATE '2021-05-17'),"
                            + "(2,3,'turn', DATE '2021-05-12'),"
                            + "(2,3,'sit', DATE '2021-05-11'),"
                            + "(2,4,'move around', DATE '2021-05-18'),"
                            + "(2,4,'turn', DATE '2021-05-15'),"
                            + "(2,4,'sit', DATE '2021-05-12'),"
                            + "(2,5,'move around', DATE '2021-05-19'),"
                            + "(2,5,'turn', DATE '2021-05-21'),"
                            + "(2,5,'sit', DATE '2021-05-23'),"
                            + "(2,6,'move around', DATE '2021-05-20'),"
                            + "(2,6,'turn', DATE '2021-05-24'),"
                            + "(2,6,'sit', DATE '2021-05-28'),"
                            + "(2,7,'move around', DATE '2021-05-21'),"
                            + "(2,7,'turn', DATE '2021-05-20'),"
                            + "(2,7,'sit', DATE '2021-05-19'),"
                            + "(2,8,'move around', DATE '2021-05-22'),"
                            + "(2,8,'turn', DATE '2021-05-11'),"
                            + "(2,8,'sit', DATE '2021-05-10'),"
                            + "(2,9,'move around', DATE '2021-05-23'),"
                            + "(2,9,'turn', DATE '2021-05-18'),"
                            + "(2,9,'sit', DATE '2021-05-14'),"
                            + "(2,10,'move around', DATE '2021-05-24'),"
                            + "(2,10,'turn', DATE '2021-05-11'),"
                            + "(2,10,'sit', DATE '2021-05-25'),"
                            + "(2,11,'move around', DATE '2021-05-16'),"
                            + "(2,11,'turn', DATE '2021-05-26'),"
                            + "(2,11,'sit', DATE '2021-05-30'),"
                            + "(5,12,'move around', DATE '2021-05-17'),"
                            + "(5,12,'turn', DATE '2021-05-12'),"
                            + "(5,12,'sit', DATE '2021-05-13'),"
                            + "(5,13,'move around', DATE '2021-05-14'),"
                            + "(5,13,'turn', DATE '2021-05-15'),"
                            + "(5,13,'sit', DATE '2021-05-16'),"
                            + "(5,14,'move around', DATE '2021-05-18'),"
                            + "(5,14,'turn', DATE '2021-05-14'),"
                            + "(5,14,'sit', DATE '2021-05-13'),"
                            + "(5,15,'move around', DATE '2021-05-25'),"
                            + "(5,15,'turn', DATE '2021-05-21'),"
                            + "(5,15,'sit', DATE '2021-05-11'),"
                            + "(5,16,'move around', DATE '2021-05-16'),"
                            + "(5,16,'turn', DATE '2021-05-13'),"
                            + "(5,16,'sit', DATE '2021-05-10'),"
                            + "(5,17,'move around', DATE '2021-05-21'),"
                            + "(5,17,'turn', DATE '2021-05-22'),"
                            + "(5,17,'sit', DATE '2021-05-23'),"
                            + "(5,18,'move around', DATE '2021-05-24'),"
                            + "(5,18,'turn', DATE '2021-05-18'),"
                            + "(5,18,'sit', DATE '2021-05-29'),"
                            + "(5,19,'move around', DATE '2021-05-24'),"
                            + "(5,19,'turn', DATE '2021-05-12'),"
                            + "(5,19,'sit', DATE '2021-05-12'),"
                            + "(5,20,'move around', DATE '2021-05-15'),"
                            + "(5,20,'turn', DATE '2021-05-12'),"
                            + "(5,20,'sit', DATE '2021-05-14'),"
                            + "(5,21,'move around', DATE '2021-05-25'),"
                            + "(5,21,'turn', DATE '2021-05-26'),"
                            + "(5,21,'sit', DATE '2021-05-19'),"
                            + "(8,22,'move around', DATE '2021-05-18'),"
                            + "(8,22,'turn', DATE '2021-05-17'),"
                            + "(8,22,'sit', DATE '2021-05-14'),"
                            + "(8,23,'move around', DATE '2021-05-13'),"
                            + "(8,23,'turn', DATE '2021-05-12'),"
                            + "(8,23,'sit', DATE '2021-05-11'),"
                            + "(8,24,'move around', DATE '2021-05-27'),"
                            + "(8,24,'turn', DATE '2021-05-18'),"
                            + "(8,24,'sit', DATE '2021-05-28'),"
                            + "(8,25,'move around', DATE '2021-05-15'),"
                            + "(8,25,'turn', DATE '2021-05-14'),"
                            + "(8,25,'sit', DATE '2021-05-11'),"
                            + "(8,26,'move around', DATE '2021-05-23'),"
                            + "(8,26,'turn', DATE '2021-05-24'),"
                            + "(8,26,'sit', DATE '2021-05-15'),"
                            + "(8,27,'move around', DATE '2021-05-25'),"
                            + "(8,27,'turn', DATE '2021-05-31'),"
                            + "(8,27,'sit', DATE '2021-05-30');");
            stmt.executeUpdate("INSERT INTO Cage(cage_size, cage_type) VALUES" + "(1000, 'circle'),"
                    + "(1200, 'square')," + "(6100, 'circle')," + "(2600, 'rectangular')," + "(2000, 'circle'),"
                    + "(4000, 'square')," + "(1500, 'aquarium')," + "(1000, 'aquarium'),"
                    + "(2300, 'rectangular');");
            ...
            stmt.executeUpdate("INSERT INTO Buys(item_id, user_id, amount, purchase_date) VALUES"
                    + "(1,1,1, DATE '2018-07-10')," + "(4,1,1, DATE '2021-03-10')," + "(3,9,3, DATE '2021-05-10');");
            stmt.executeUpdate("INSERT INTO Assigns VALUES"
                    + "(2,1,4)," + "(2,2,7)," + "(5,3,7)," + "(8,4,7);");
